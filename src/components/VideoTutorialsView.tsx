      ...
      >
        ...
        >
          ...
          {selectedLesson && hasError && (
            <div className="w-full h-full flex flex-col items-center justify-center p-6 text-center bg-gradient-to-b from-slate-900 to-[#0B1120] text-slate-200 space-y-4">
