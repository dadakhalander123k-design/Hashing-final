  ...
  return (
    ...
    >
      <svg
        ...
        className="h-full w-auto max-h-8 sm:max-h-8.5 overflow-visible select-none pointer-events-none"
        preserveAspectRatio="xMidYMid meet"
      >
        <defs>
          {/* Gradients for Graduation Cap */}
          {/* 1. Mortarboard Top (Diamond) */}
          <linearGradient id="algoCapTopLight" x1="12" y1="12" x2="88" y2="60" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#0B1E5C" />
            <stop offset="45%" stopColor="#1D4ED8" />
            <stop offset="100%" stopColor="#2563EB" />
          </linearGradient>

          <linearGradient id="algoCapTopDark" x1="12" y1="12" x2="88" y2="60" gradientUnits="userSpaceOnUse">
          ...
          <linearGradient id="algoCapEdgeGlow" x1="10" y1="36" x2="52" y2="12" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor={isDark ? "#38BDF8" : "#93C5FD"} stopOpacity={isDark ? "0.95" : "0.75"} />
            <stop offset="100%" stopColor="#3B82F6" stopOpacity="0.25" />
          </linearGradient>

          {/* 2. Cap Base / Lower Section (Vibrant Violet -> Royal Blue -> Electric Cyan) */}
          <linearGradient id="algoCapBaseLight" x1="26" y1="52" x2="78" y2="82" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#7C3AED" />
            <stop offset="45%" stopColor="#2563EB" />
            <stop offset="100%" stopColor="#06B6D4" />
          </linearGradient>

          <linearGradient id="algoCapBaseDark" x1="26" y1="52" x2="78" y2="82" gradientUnits="userSpaceOnUse">
          ...
          {/* 3. Tassel Gradient */}
          <linearGradient id="algoTasselGrad" x1="82" y1="38" x2="82" y2="76" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#3B82F6" />
            <stop offset="100%" stopColor="#1D4ED8" />
          </linearGradient>

          {/* 4. Wordmark 'Learn' Gradient */}
          <linearGradient id="algoLearnGradLight" x1="190" y1="24" x2="310" y2="48" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#1D4ED8" />
            <stop offset="45%" stopColor="#2563EB" />
            <stop offset="100%" stopColor="#7C3AED" />
          </linearGradient>

          <linearGradient id="algoLearnGradDark" x1="190" y1="24" x2="310" y2="48" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#3B82F6" />
        ...
        <g id="graduation-cap-symbol">
          ...
          <path
            ...
            fill={isDark ? "url(#algoCapBaseDark)" : "url(#algoCapBaseLight)"}
          />
        ...
        <g id="algolearn-branding">
          ...
          <text
            ...
            fontWeight="800"
            letterSpacing="-0.025em"
            fill={isDark ? "url(#algoLearnGradDark)" : "url(#algoLearnGradLight)"}
          >
            Learn
          </text>
