      ...
      <div className="bg-white dark:bg-[#111827] w-full max-w-2xl border border-slate-200 dark:border-slate-800 rounded-2xl shadow-xl dark:shadow-[0_8px_30px_rgba(0,0,0,0.35)] overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 overflow-y-auto space-y-4 bg-white dark:bg-[#111827]">
          {topics.map((topic, idx) => (
            <div
              key={idx}
              className="p-4 bg-slate-50/70 dark:bg-[#0B1120] border border-slate-200/80 dark:border-slate-800 rounded-xl shadow-2xs dark:shadow-[0_0_12px_rgba(0,0,0,0.3)]"
            >
